...
const cars = [
  {
    ...
    emi: "₹2.5L/month",
    image: "carimg/m4.jpg", // placeholder, will fall back to default or existing img if missing
    fallbackImage: "bmw2.png",
    fuelType: "Petrol",
  ...
  },
  {
    ...
    emi: "₹1.1L/month",
    image: "carimg/c-class.jpg",
    fallbackImage: "bmwop12.jpg",
    fuelType: "Petrol",
    transmission: "Automatic",
    mileage: "14 km/l",
    category: "Sedan",
  ...
  },
  {
    ...
    emi: "₹1.7L/month",
    image: "carimg/gle.jpg",
    fallbackImage: "garageop.jpg",
    fuelType: "Diesel",
    transmission: "Automatic",
    mileage: "11 km/l",
    category: "SUV",
    ...
    const cardHTML = `
      <div class="car-card">
        <div class="card-img-container">
          ...
          <img src="${imgUrl}" alt="${car.brand} ${car.model}" onerror="this.src='bmw2.png'">
        </div>
