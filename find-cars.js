...
const cars = [
  {
    ...
    emi: "₹2.5L/month",
    image: "cars_image1/m4.jpg", // placeholder, will fall back to default or existing img if missing
    fallbackImage: "cars_image1/bmw_m4_compi.jpeg",
    fuelType: "Petrol",
  ...
  },
  {
    ...
    fallbackImage: "cars_image1/bmw x5.jpg",
    fuelType: "Diesel",
    transmission: "Automatic",
    mileage: "12 km/l",
    category: "SUV",
  ...
  },
  {
    ...
    emi: "₹1.1L/month",
    image: "cars_image1/c-class.jpg",
    fallbackImage: "cars_image1/bmwop12.jpg",
    fuelType: "Petrol",
    transmission: "Automatic",
    mileage: "14 km/l",
    category: "Sedan",
  ...
  },
  {
    ...
    emi: "₹1.7L/month",
    image: "cars_image1/gle.jpg",
    fallbackImage: "cars_image1/mercedes2.jpeg",
    fuelType: "Diesel",
    transmission: "Automatic",
    mileage: "11 km/l",
    category: "SUV",
  ...
  },
  {
    ...
    emi: "₹1.2L/month",
    image: "cars_image1/a6.jpg",
    fallbackImage: "cars_image1/garagewhite.jpg",
    fuelType: "Petrol",
    transmission: "Automatic",
    mileage: "14.1 km/l",
    category: "Sedan",
  ...
  },
  {
    ...
    fallbackImage: "cars_image1/audi Q7.jpeg",
    fuelType: "Petrol",
    transmission: "Automatic",
    mileage: "11.2 km/l",
    category: "SUV",
  ...
  },
  {
    ...
    emi: "₹3.2L/month",
    image: "cars_image1/911.jpg",
    fallbackImage: "cars_image1/Porsche 911 GT3 wallpaper front view.jpeg",
    fuelType: "Petrol",
    transmission: "Automatic",
    mileage: "9 km/l",
    category: "Coupe",
  ...
  },
  {
    ...
    emi: "₹1.4L/month",
    image: "cars_image1/f-pace.jpg",
    fallbackImage: "cars_image1/garageop.jpg",
    fuelType: "Diesel",
    transmission: "Automatic",
    mileage: "12.9 km/l",
    category: "SUV",
  ...
  },
  {
    ...
    fallbackImage: "cars_image1/range rover sport.jpg",
  ...
  },
  {
    ...
    emi: "₹1.8L/month",
    image: "cars_image1/xc90.jpg",
    fallbackImage: "cars_image1/bmw2.png",
    fuelType: "Hybrid",
    transmission: "Automatic",
    mileage: "17.2 km/l",
    category: "SUV",
  ...
  },
  {
    ...
    emi: "₹75K/month",
    image: "cars_image1/fortuner.jpg",
    fallbackImage: "cars_image1/bmwop.jpg",
    fuelType: "Diesel",
    transmission: "Manual",
    mileage: "10 km/l",
    category: "SUV",
...
function renderCars() {
  ...
  filteredCars.forEach(car => {
    ...
    // image fallback check inline for robustness
    const imgUrl = car.fallbackImage; // Using existing images since we don't have new ones in dir
